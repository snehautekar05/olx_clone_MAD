...
class _LocationScreenState extends State<LocationScreen> {
  ...
  // Define showBottomScreen function outside the _LocationScreenState class
                ...
                ListTile(
                  onTap: () {
                    ...
                    getLocation().then((value){
                      if(value != null) {
                        double latitude = value.latitude ?? 0.0; // Provide default value or handle nullable
                        ...
                        _service.updateUser({
                          ...
                          progressDialog.dismiss();
                          return Navigator.pushNamed(context,MainScreen.id);
                        });
                      }
                    });
                  ...
                  title: Text('Use current location', style: TextStyle(
                    color: Colors.blue,
                ...
                Padding(
                  ...
                  child: CSCPicker(
                    ...
                    onCityChanged: (value) {
                      ...
                      //send this address to firestore
                      if(value!=null){
                        _service.updateUser({
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.locationChanging == null) {
      _service.users.doc(_service.user?.uid).get().then((
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Image.asset('assets/images/map.png', height: 350),
          SizedBox(height: 20),
          Text(
          ...
          Text(
            'To fully enjoy all that we have to offer,\nwe need to know where to look for it',
            textAlign: TextAlign.center,
            style: TextStyle(fontSize: 12),
          ),
          SizedBox(
